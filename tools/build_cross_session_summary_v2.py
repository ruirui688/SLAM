"""
Build a stronger cross-session summary with label normalization + geometry-aware clustering
for real industrial first-8-frame outputs.
"""
...
def main() -> None:
    ...
    print(json.dumps({'output': str(args.output), 'num_clusters': len(clusters)}, indent=2, ensure_ascii=False))
